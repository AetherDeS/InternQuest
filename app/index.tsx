  ...
  return (
    <Tab.Navigator initialRouteName="Home" screenOptions={{
      ...
      <Tab.Screen name="Events" component={EventScreen} options={{
          tabBarIcon: ({ focused }) => (
            <View style={{ height: 30 }}>
              <Icon name="calendar-outline" size={30} color={focused ? accent1 : '#A1A0A0'}/>
            </View>
          ),}}/>
      ...
      <Tab.Screen name="News" component={NewsScreen} options={{
          tabBarIcon: ({ focused }) => (
            <View style={{ height: 30 }}>
              <Icon name="chatbubbles-outline" size={30} color={focused ? accent1 : '#A1A0A0'}/>
            </View>
          ),}}/>
      ...
      <Tab.Screen name="Profile" component={ProfileScreen} options={{
          tabBarIcon: ({ focused }) => (
            <View style={{ height: 30 }}>
              <Icon name="person-outline" size={30} color={focused ? accent1 : '#A1A0A0'}/>
            </View>
          ),}}/>
    </Tab.Navigator>
  );
